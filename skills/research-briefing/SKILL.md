...
If current source access is unavailable or a required source cannot be retrieved, identify the affected claims as unverified or unknown. Continue only with portions that remain reliable, and never fabricate citations or imply that verification occurred.
